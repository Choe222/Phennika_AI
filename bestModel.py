...
class AspectCorrelationHead(nn.Module):
    def __init__(self, embed_size, num_labels=6, num_heads=8):
        ...
        self.attention = nn.MultiheadAttention(embed_dim=embed_size, num_heads=num_heads, batch_first=True, dropout=0.2)
...
class MLPb(nn.Module):
    def __init__(self, model_name="vinai/phobert-base-v2", freeze_encoder=False):
        super().__init__()
